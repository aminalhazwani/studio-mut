				...
				<?php foreach($project->images() as $image): ?>
					<?php if($image->cover() == 'ja'): ?>
						<a href="<?php echo $project->url() ?>">
							<img class="lazyload" src="<?php echo thumb($image, array('width' => 1200, 'height' => 900, 'quality' => 70), false) ?>" alt="<?php echo html($project->title()) ?>" sizes="100vw" 
					 data-srcset="<?php echo thumb($image, array('width' => 600, 'height' => 400, 'quality' => 70), false) ?> 600w,
